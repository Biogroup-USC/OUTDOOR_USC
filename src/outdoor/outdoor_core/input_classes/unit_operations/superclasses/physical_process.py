...
class PhysicalProcess(Process):
    ...
    This is the mother class of all real physical unit-operations such as
    reactors, splitters (columns etc.). It inherits from the Process-Class.
    Additionally it includes data for capital costs and energy demands.

    Similar to the Process-Class it inclues setter-methods to fill in data
    in the parameters.
    """
    ...
    def __set_kappa_2_capex(self, kappa_2_capex_string):
        ...
        elif kappa_2_capex_string == 'FIN_ALL':# consider the total flow going though the unit as reference flow
            self.kappa_2_capex['kappa_2_capex'][self.Number] =  6
